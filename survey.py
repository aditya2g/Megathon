...
class SurveyNavigator:
    ...
    def start(self):
        ...
        for cur in path:
             self.client.moveToPositionAsync(cur.x_val, cur.y_val, cur.z_val, self.velocity).join()
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--altitude", type=float, help="altitude of survey (in positive meters)", default=50)
